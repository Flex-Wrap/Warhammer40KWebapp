    ...
    <div className="page scrollable-content">
      ...
      <section className="latest-releases">
        ...
        <div className="releases-grid">
          <BoardGameCard backgroundImage={boardgame} title="Risk: Warhammer 40K Edition" tags={["Tabletop", "Strategy", "Warhammer", "Longer Tag Test"]} description="Conquer the Warhammer 40K universe in this thrilling take on the classic Risk game. Command your forces across multiple worlds as you battle for supremacy." />
          <BoardGameCard backgroundImage={boardgame} title="Risk: Warhammer 40K Edition" tags={["Tabletop", "Strategy", "Warhammer"]} description="Conquer the Warhammer 40K universe in this thrilling take on the classic Risk game. Command your forces across multiple worlds as you battle for supremacy." />
          <BoardGameCard backgroundImage={boardgame} title="Risk: Warhammer 40K Edition" tags={["Tabletop", "Strategy", "Warhammer"]} description="Conquer the Warhammer 40K universe in this thrilling take on the classic Risk game. Command your forces across multiple worlds as you battle for supremacy." />
          <BoardGameCard backgroundImage={boardgame} title="Risk: Warhammer 40K Edition" tags={["Tabletop", "Strategy", "Warhammer"]} description="Conquer the Warhammer 40K universe in this thrilling take on the classic Risk game. Command your forces across multiple worlds as you battle for supremacy." />
          <BoardGameCard backgroundImage={boardgame} title="Risk: Warhammer 40K Edition" tags={["Tabletop", "Strategy", "Warhammer"]} description="Conquer the Warhammer 40K universe in this thrilling take on the classic Risk game. Command your forces across multiple worlds as you battle for supremacy." />
        </div>
